          ...
          <div class="card">
            <div class="card-body">
              ...
              <div style="display: flex; justify-content: space-evenly;">
                <div class="git">
                  <a href="https://github.com/login/oauth/authorize?scope=user%20repo%20project&client_id=Iv1.e56abdcaeb74675d" style="display: block; padding-left: 50px;"><img alt="" src="${ pageContext.request.contextPath }/resources/image/github.png" width="50px" style="display: block; margin: auto;"></a>
                </div>
                <div class="kaka">
